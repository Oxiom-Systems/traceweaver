...
status: accepted_controlled_baseline_with_review_pending_candidate_requirements
date: 2026-04-30
...
acceptance_state: accepted_for_approved_requirements_candidate_requirements_review_pending
...
candidate_amendment_status: review_pending
owner: Oxiom Systems
---
...
requirements. Candidate requirements added after the last accepted amendment
remain review-pending and are not accepted implementation authority until a
clean requirements review promotes them.
...
| REQ-TW-049 - REQ-TW-050 | User workflow feedback on 2026-05-05, `docs/validation/traceweaver-skill-behavior-audit.md`, `plugins/traceweaver-core/skills/tw-code-review/SKILL.md`, and `plugins/traceweaver-core/skills/tw-doc-review/SKILL.md` | Candidate review-wrapper requirements recorded for `tw-code-review` and `tw-doc-review`; not accepted until clean requirements/doc review promotes them | Candidate only / review pending | Requirements review, authority-set doc review, deterministic behavior fixtures, install/discovery smoke, and runtime review-wrapper behavior proof remain required |
| REQ-TW-051 | CE 3.5.0 source worktree at upstream commit `1f3c6466e4eb4e1b584c658953dfb1ca98dd3335` compared against `plugins/traceweaver-core/skills/` | Candidate CE full-surface classification requirement records 20 unclassified/missing CE skills by name from a clean 3.5.0 source surface | Candidate only / review pending | Requirements review, source/provenance acceptance, classification evidence, matrix update, and wrapper/out-of-scope decisions remain required |
| REQ-TW-052 | User workflow feedback on 2026-05-05 and the CE 3.5.0 packaged/missing skill inventory | Candidate TW-wrapper backlog requirement records the need to route each familiar CE skill through a TW wrapper, alias, `tw-auto` phase, selected manual-continuity surface, hidden/internal status, held future surface, or out-of-scope decision | Candidate only / review pending | Requirements review, wrapper backlog artifact, matrix update, behavior contracts, install/discovery smoke, and fixture/runtime proof remain required |
| REQ-TW-053 | User workflow feedback on 2026-05-05, `plugins/traceweaver-core/skills/tw-auto/SKILL.md`, packaged publication-wrapper candidates, and future publication-route proof | Candidate controlled publication-route requirement recorded so `tw-auto` can eventually automate staging, commit, push, and PR after normal code verification/review passes, while routing requirement/authority changes back through requirements review | Candidate only / review pending | Requirements review for changed authority, publication-route plan, negative publication smoke, publication-wrapper behavior proof, credential/remote boundary proof, authority doc review, and human/Intent Contract override policy remain required |
| REQ-TW-054 | User workflow feedback on 2026-05-05 and dogfood audit gap for missing code-level anchors | Candidate code/test trace-anchor requirement recorded so behavior-bearing files, high-level functions, tests, fixtures, and smoke scripts can be linked to requirements and verification IDs without line-by-line annotation | Candidate only / review pending | Code-anchor scanner plan, matrix code-anchor table, fixture proof, `tw-code-review` preflight update, authority doc review, and dead-TDD detection evidence remain required |
| REQ-TW-055 | User workflow feedback on 2026-05-05 that `tw-traceability-check` must produce review issues like code/doc review | Candidate structured traceability-finding requirement recorded so trace gaps become actionable findings with severity, evidence, file/line anchors when available, claim impact, and remediation | Candidate only / review pending | Structured-finding fixtures, `tw-traceability-check` implementation, `tw-code-review`/`tw-doc-review` integration, code review, and authority doc review remain required |
...
1. Review REQ-TW-049 through REQ-TW-055 before using `tw-code-review`,
   `tw-doc-review`, CE full-surface parity claims, or any broader TW-wrapper
   backlog/publication-route/code-anchor/structured-finding behavior as accepted
   TraceWeaver workflow authority.
