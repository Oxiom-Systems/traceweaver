...
| SRC-VAL-004 | `docs/validation/traceweaver-core-11-ce-runtime-inventory.md` | `1d2c3584579f26a934d70c5bd6f554c9ace3ad53a03b6058fb014244468562fc` | CE-DOC-REVIEW-2026-04-30-REQ-MASTER-CLEAN-001 | CE 3.8.1 runtime inventory for clean-swap planning, amended for the packaged `lfg` alias delta, selected CE package-boundary deltas, consolidated `ce-sessions` session surface, and refreshed no-publication holds for commit, PR, code-review, and PR-feedback paths. |
