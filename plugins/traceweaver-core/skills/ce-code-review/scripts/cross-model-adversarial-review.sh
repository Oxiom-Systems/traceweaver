...
skip "TraceWeaver packaged cross-model code egress is held; use the in-process adversarial reviewer"
...
cursor_egress_ok() { in_csv cursor "$ALLOW" || in_csv composer "$ALLOW"; }
