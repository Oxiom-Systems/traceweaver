# Fixture Validation Definition Artifact (review-not-passed)

Status: fixture only, for `tw-vv-define` capsule validator's
`--require-review-passed` mode smoke coverage. Not a real requirement's
validation record.
...
`fixtures/vv-define/review-not-passed/red-evidence/red_run.txt`
