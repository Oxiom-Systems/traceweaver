...
- R5. The MVP must satisfy lifecycle management through the standalone skill's trigger conditions, checkpoints, and completion gates. Slash-command wiring, lifecycle-skill patches, and automatic activation are follow-up work unless maintainers explicitly request them.
