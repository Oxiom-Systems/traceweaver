...
TraceWeaver clean-swap plan. It does not copy CE files into TraceWeaver, prove
CE runtime loading, prove CE agent installation, approve a clean swap, or create
U7 release claims.
...
Decision state: `recorded_source_inventory_only`

Allowed use:

- plan the TraceWeaver clean-swap runtime bundle;
- decide which CE files need license/provenance/hash records before copying;
- identify agent-backed CE claims that remain held until runtime install proof.

Held claims:

- TraceWeaver replaces Compound Engineering cleanly;
- CE workflow skills are installed from TraceWeaver;
- CE reviewer/research agents are installed from TraceWeaver;
...
| Upstream commit/tag | Not recorded in this inventory; must be added before public vendoring or release claim |
| Full cache file count | 218 files |
| Skills file count | 159 files |
| Agent file count | 51 files |
| Full cache aggregate fingerprint | `2c9de5f037de299a7168f408296898193d9ab32a4a950c131919b4623588877a` over sorted SHA-256 output |
...
| --- | --- | --- |
| `skills/ce-brainstorm/SKILL.md` | `bc810faa7a03d736462f7a27c496f7b168d0d3aafece933fa7a68b01371d0f99` | selected skill file |
...
| `skills/ce-code-review/SKILL.md` | `26306536f03f40355eb64fe0f63cd28064756d660917499ed312620ca2c36d96` | selected skill file |
...
| `skills/ce-code-review/references/persona-catalog.md` | `0a1ca85273d831bd448c3979a155976756ef0fcb59a9d68b336722c7ee7d4a61` | selected skill file |
...
| `skills/ce-commit-push-pr/references/pr-description-writing.md` | `3e6a9161a95e086ac285f9df24128384ca47209b01287c8d1e08dd414de7fc0b` | selected skill file |
...
| `skills/ce-compound/SKILL.md` | `3af0175f33404c7eabc5950a417fa51af5d816409058ecfb1d29e1bce1ff0952` | selected skill file |
...
| `skills/ce-plan/SKILL.md` | `3903bbf4028dd712d747e850b19933744be5bbd4aa9b54a25706f3f2820e8511` | selected skill file |
...
| `skills/ce-plan/references/synthesis-summary.md` | `d827272aae022bb5704f352d30fd6c0c0a13d706812a6a76cf9e5ffd53a2ac6b` | selected skill file |
...
| `skills/ce-sessions/SKILL.md` | `8f92b24090bf6b5639fa77f09bb79392c30fb000c725652c7d302167179b88e9` | selected skill file |
| `skills/ce-setup/SKILL.md` | `328f97634a1e1196d7ea0b5101547d1a28a7cb8dacd7509df631104e35864c05` | selected skill file |
| `skills/ce-setup/references/config-template.yaml` | `e007a72d74b76f4817036f6cf40b81854a911dfa378149094dce96441cf3186c` | selected skill file |
...
| `skills/ce-work/SKILL.md` | `78fb01e3c851f47ad6006396ef5a410788fd3f5f9b58e64b09c76b684264ccc2` | selected skill file |
| `skills/ce-work/references/shipping-workflow.md` | `0254b3922e726a71931cd6430caf451fc1791204c454ad30786ad084935e7658` | selected skill file |
...
All CE agent files are selected for continuity analysis because CE review,
document-review, research, and compound workflows can route through conditional
agent personas. Runtime agent installation remains unproven in this record.

| Source file | SHA-256 | Decision |
| --- | --- | --- |
| `agents/ce-adversarial-document-reviewer.agent.md` | `64f53b939d70fef8b98081e0e716ac57245a4223f4693b50b68a341d6735d400` | selected agent file; runtime install support unproven |
| `agents/ce-adversarial-reviewer.agent.md` | `10c048173c86e8cdbf295fb6e7f04595902466dad201bf56d29e23fcc317a8bc` | selected agent file; runtime install support unproven |
| `agents/ce-agent-native-reviewer.agent.md` | `51e1529ae2900178b255595e20335fbb8a8bf27c7005b41a681944c5f13b998a` | selected agent file; runtime install support unproven |
| `agents/ce-ankane-readme-writer.agent.md` | `a0ed6f5bc201c53d616cc6eb6e214ab6d3a7927d255b8f447cee07d254d5b8a6` | selected agent file; runtime install support unproven |
| `agents/ce-api-contract-reviewer.agent.md` | `a72c578e0ef9ec36b5e8038b4e21685df73e99d4bc16227f717d104bfdbfeb0a` | selected agent file; runtime install support unproven |
| `agents/ce-architecture-strategist.agent.md` | `fc4b7f1509c18abc21733a41214a7e946780de8900c53cf04de2186685550215` | selected agent file; runtime install support unproven |
| `agents/ce-best-practices-researcher.agent.md` | `14896ea6d69adae21df8d038f38887c2b12aa415a094e4f891ef24d28fd5ac93` | selected agent file; runtime install support unproven |
| `agents/ce-cli-agent-readiness-reviewer.agent.md` | `c99138467f488e9f7af9937216e2f0ef672dc72bfe50d655eeb11ec85a456fb5` | selected agent file; runtime install support unproven |
| `agents/ce-cli-readiness-reviewer.agent.md` | `f73483e93ea2b74fd60222a51bd7192b6bd8a2f9f4f186ddfd6b57215e999c3c` | selected agent file; runtime install support unproven |
| `agents/ce-code-simplicity-reviewer.agent.md` | `63cb66c233586601d9d34b1d2cb1fed19bb5c23b5c44b96233f7cad0301df1ce` | selected agent file; runtime install support unproven |
| `agents/ce-coherence-reviewer.agent.md` | `f37c49be80d20673f189f08184000dfe4d842c384436bd9141ae0ef9cacad354` | selected agent file; runtime install support unproven |
| `agents/ce-correctness-reviewer.agent.md` | `ad9109c34c38e6992f5b1a48090d97b8a66b5f943a9d0525ad290325a3aa3254` | selected agent file; runtime install support unproven |
| `agents/ce-data-integrity-guardian.agent.md` | `347d596bf1e88296bd0caddb7de32a9b9ea2ac8f849d09aa3323d346310a2a86` | selected agent file; runtime install support unproven |
| `agents/ce-data-migration-expert.agent.md` | `9cf8dcb6441db0aa1e934ce15e4ae207b12ee35634317d78e61e1615d6bfa05e` | selected agent file; runtime install support unproven |
| `agents/ce-data-migrations-reviewer.agent.md` | `36ac2a80f35717cb67cc5a0b0e70715333ecf79cc377a95b2094b5c67069b09e` | selected agent file; runtime install support unproven |
| `agents/ce-deployment-verification-agent.agent.md` | `0706a19e1d01db7654dafe01a1239d6e03703323686b481e0a10fc06b1442633` | selected agent file; runtime install support unproven |
| `agents/ce-design-implementation-reviewer.agent.md` | `3d9a37f8989cb06e9fa9716376ff746c3d5d3405ecaca3b282b09bad08e398da` | selected agent file; runtime install support unproven |
| `agents/ce-design-iterator.agent.md` | `f64f4cff3108dcf701f94995ec6626f9fd7422b733426fce8a0c105bc4a72bd5` | selected agent file; runtime install support unproven |
| `agents/ce-design-lens-reviewer.agent.md` | `c8715d27a842e54d005a5e034a04880f95a84b9430a061162975b585c544de28` | selected agent file; runtime install support unproven |
| `agents/ce-dhh-rails-reviewer.agent.md` | `4a47d70cf5c6a1ccb00a3db9f9979a45e8e422bbd4844a178ce708df349044ac` | selected agent file; runtime install support unproven |
| `agents/ce-feasibility-reviewer.agent.md` | `3473e9b00cbaa0ffa11f85548cabc27ffd1d0db17d2fc27e66b556a42ab36b01` | selected agent file; runtime install support unproven |
| `agents/ce-figma-design-sync.agent.md` | `652a4c95ce6339bd718b95bbb22a4bc00e837d553653b283e7369cc0d4a198a7` | selected agent file; runtime install support unproven |
| `agents/ce-framework-docs-researcher.agent.md` | `67aef22bd96b2c5d3390fc7d1d5d7a9208619bc0b116c447f42cf3c36e8bc244` | selected agent file; runtime install support unproven |
| `agents/ce-git-history-analyzer.agent.md` | `d51fdbc3042e02fe5dbc048009e18696780c6d10e2e00c58f3d7e6a49f49974b` | selected agent file; runtime install support unproven |
| `agents/ce-issue-intelligence-analyst.agent.md` | `fa3cbc5a329937777eef03c4825e4b02a4f00ca6e5b9e01637a72ce89e8cb17f` | selected agent file; runtime install support unproven |
| `agents/ce-julik-frontend-races-reviewer.agent.md` | `0268819b5b703e06cd5ec5b9bf1c0dfe82a681053bab4c6d353dafa96079df6f` | selected agent file; runtime install support unproven |
| `agents/ce-kieran-python-reviewer.agent.md` | `0342cac76d65e1b08846511702dee22c7a0dcee86cc419103281e0729c916fa4` | selected agent file; runtime install support unproven |
| `agents/ce-kieran-rails-reviewer.agent.md` | `211521d4917516e599ec3ba36e6e1a77851f51c3987bc8bd35b427373444b41f` | selected agent file; runtime install support unproven |
| `agents/ce-kieran-typescript-reviewer.agent.md` | `dbc1408f8fe363b54faa189258b2d36069b138ff234916ef8fecfa83a6c9dcb9` | selected agent file; runtime install support unproven |
| `agents/ce-learnings-researcher.agent.md` | `6daea986282d0206e93242a30c2359a096228c14a221f0672a181f351188bfbd` | selected agent file; runtime install support unproven |
| `agents/ce-maintainability-reviewer.agent.md` | `961aa326d70c5aacffd0da239373b369030661a7c85c41556c4187b81b850cde` | selected agent file; runtime install support unproven |
| `agents/ce-pattern-recognition-specialist.agent.md` | `1b956a44a75bcc6ec2a0e2d848d77b5b95290eaffe4bc291b2fbfa9e98800fc9` | selected agent file; runtime install support unproven |
| `agents/ce-performance-oracle.agent.md` | `e293484072ffc06cf72a2e78e8c8934a966e91b98fe2029d58142941b7b14e18` | selected agent file; runtime install support unproven |
| `agents/ce-performance-reviewer.agent.md` | `efbc47187e7c1db5d6a866af85cbd17793b050c9eb17562a1fb640af653e74a6` | selected agent file; runtime install support unproven |
| `agents/ce-pr-comment-resolver.agent.md` | `c3364f9dccd9cecb75504b759baf74c246b7df24740e8aa0a171fe604099d9df` | selected agent file; runtime install support unproven |
| `agents/ce-previous-comments-reviewer.agent.md` | `c098443eb8049f1bfcc41906daf9635408eb2f16cd7449eac2d110b975d62a25` | selected agent file; runtime install support unproven |
| `agents/ce-product-lens-reviewer.agent.md` | `3640eb11e238ffad994e0c182723b27550dadbdf262972af62c3f8da567b8d4e` | selected agent file; runtime install support unproven |
| `agents/ce-project-standards-reviewer.agent.md` | `912946be877ee20974fbb32f312a1811af945bb0668fc786ff99fba8167d473e` | selected agent file; runtime install support unproven |
| `agents/ce-reliability-reviewer.agent.md` | `fc932495cc074f830c61324ea66066927756d7fba995b2d13023aa3a5b732354` | selected agent file; runtime install support unproven |
| `agents/ce-repo-research-analyst.agent.md` | `f2ee62dd210e8d429a88bb531fa0939925288191dd7ac5678e6d74b2142f8135` | selected agent file; runtime install support unproven |
| `agents/ce-schema-drift-detector.agent.md` | `bc82f0d9f07ed6fec40b88465f882e51a472c4dcb3992bd85a68db2fc215112f` | selected agent file; runtime install support unproven |
| `agents/ce-scope-guardian-reviewer.agent.md` | `a1f85b17849c59b156f15380f2e47f6c84ac44830796a86e11fb93be8f317280` | selected agent file; runtime install support unproven |
| `agents/ce-security-lens-reviewer.agent.md` | `d8bba13fda6e05b8e68ec874235563bd8d2af5d1ec1c80635b07c73250de1eef` | selected agent file; runtime install support unproven |
| `agents/ce-security-reviewer.agent.md` | `b44acfab82dab3c0dd03a3a9df523fefad63b7065577cbe97af889aabcf02fdd` | selected agent file; runtime install support unproven |
| `agents/ce-security-sentinel.agent.md` | `0c7abeb915f31cc28190e8a21f15a3582985bb2951b32ac5253627c845a05240` | selected agent file; runtime install support unproven |
| `agents/ce-session-historian.agent.md` | `2234452d517bc868c495cc1bbd8218e2384017124e49bc7c89b3b0a5e0e6bf5e` | selected agent file; runtime install support unproven |
| `agents/ce-slack-researcher.agent.md` | `d84530b1acad8195be22c40c91b18f88d51b06884eb4c49ae220dd25573c12bd` | selected agent file; runtime install support unproven |
| `agents/ce-spec-flow-analyzer.agent.md` | `b135a42e802bd85e5f0db2556c1bbaf72ed61f9510a996e1e4bcdfa2d4ab1a3d` | selected agent file; runtime install support unproven |
| `agents/ce-swift-ios-reviewer.agent.md` | `4fc98bc377c11b8181c4da695435e1b50e16b0e244721cb6a5de24eef7e62299` | selected agent file; runtime install support unproven |
| `agents/ce-testing-reviewer.agent.md` | `251aebac37d54edc4356485d6f37711bc58839d8a9920a337ae93de51a90e50e` | selected agent file; runtime install support unproven |
| `agents/ce-web-researcher.agent.md` | `f1152ea936092884fed55ff541c5b5dc53fbe1b185eae4d4c421a1676d27697e` | selected agent file; runtime install support unproven |
