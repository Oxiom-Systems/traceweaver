...
| `docs/plans/2026-05-02-003-feat-u9-codex-runtime-discovery-proof-plan.md` | `53cec3cff757a9ccb01b874d2a2d4ff0a93bdb000bb8089d45596acf872cd52c` | U9 Codex runtime/discovery proof plan | Unit 1 through Unit 8 reviewed/held inputs plus Unit 9 registry-shape, legacy-upgrade repair, and auth-boundary patch with refreshed code/doc review pending; host-registry/runtime claims remain held. |
